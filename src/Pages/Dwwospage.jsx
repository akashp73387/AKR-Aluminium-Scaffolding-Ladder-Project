...
const Dwwospage = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-gray-900 mb-3">
            ...
            <span className="text-blue-700">Without Stairway</span>
          </h1>
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
            Professional-grade double width scaffolding system designed for safe
            and efficient access in wide working areas, without the need for an
      ...
      {/* Image + Features */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-6 lg:px-8 pb-10">
        {/* Image Gallery */}
        <motion.div
            ...
            {images.map((image, index) => (
              ...
              >
                <img
                  src={image.src}
                  alt={image.alt}
                  className={`w-full h-20 sm:h-24 object-cover rounded-lg transition-all duration-300 ${
                    currentImage === index
        ...
        <motion.div
          ...
          className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-inner h-full overflow-y-auto"
          style={{ backgroundColor: "#0a2647" }}
        >
          <h3 className="text-lg sm:text-xl font-semibold text-white mb-4">
            Scaffolding Specifications & Features
          </h3>
          <ul className="text-white space-y-6 sm:space-y-8 text-sm">
            {[
              "Made of high-quality aluminium alloy with 50mm dia aluminium pipes",
              "This scaffolding has 2.0m (length) x 1.4m (width) platform size with platform height starting from 2.2m to 16.2m.",
              ...
              "Bracings are claw mechanism spring type with ease of fixing and removal",
              ...
              <li
                key={idx}
                className="relative pl-6 before:content-['✔️'] before:absolute before:left-0"
              >
                {item}
              </li>
            ))}
      ...
      {/* Content Section */}
      <div className="bg-[#F1F5F9] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 rounded-xl shadow-sm">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 border-b border-gray-300 pb-2">
        ...
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
          ...
          safe option while working at heights. The specially designed stairways
          are easily accessible and user friendly when working with tools. Our
          professionals adhere to industry standards and ensure to opt for
          machinery and manual tests before dispatching the scaffolding to the
          clients. Making use of the perfect access equipment can reduce your
          work load significantly and help you complete your task more quickly
          and safely. You can also trust our knowledge to ensure that you get
          the right equipment in accordance with your job requirement.
        </p>
      </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-10 pb-20">
        <div className="overflow-x-auto">
          <table className="min-w-full bg-blue-50 shadow-lg rounded-lg border-separate border-spacing-0 ring-1 ring-blue-300">
            <thead>
              <tr>
                <th
                  colSpan={7}
                  className="px-4 py-4 text-lg sm:text-2xl font-bold text-blue-900 text-center bg-blue-50"
                >
                  Specifications
                </th>
              </tr>
