...
const Swwspage = () => {
  ...
  return (
    <div className="w-full ">
      <Navbar />
      {/* Header */}
      <div className="max-w-7xl mx-auto py-6 md:py-10 px-4 sm:px-6 lg:px-8 rounded-xl">
        <motion.div
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A2647] mb-2 md:mb-3">
            ...
            <span className="text-blue-600 block sm:inline">With Stairway</span>
          </h1>
      ...
      <div className="bg-[#F1F5F9] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 rounded-xl shadow-sm">
        ...
        <p className="text-gray-700 text-sm md:text-base leading-relaxed">
          The Instafit Single Width Scaffolding With Stairway is the ideal and
          safe option while working at heights where space is limited. Designed
          for compact areas, it ensures maximum functionality without
          compromising on safety. The integrated stairway system offers
          effortless access between levels, making it incredibly
          user-friendly—especially when carrying tools or equipment. Its
          ergonomic design minimizes strain and increases productivity for
          professionals working at elevated heights. Constructed from
          lightweight yet durable aluminium, the scaffold is easy to transport
          and quick to assemble without the need for special tools. The stable
          platform and anti-slip stairs provide confidence and balance, even
          during extended work sessions. Whether you're in construction,
          maintenance, or installation, this scaffolding solution offers a
          secure and practical setup that's both efficient and compliant with
          industry standards.
        </p>
      </div>
  ...
  <div className="max-w-5xl mx-auto w-full overflow-x-auto"> {/* Added max-width and center */}
        ...
        <table className="min-w-full table-fixed divide-y divide-blue-200">
          <thead className="bg-blue-50">
            ...
            <tr className="bg-blue-200">
              ...
              {["ISFSW-002", "ISFSW-004", "ISFSW-006", "ISFSW-008"].map(
                (code, idx) => (
                  <th
                    key={idx}
          ...
          <tbody className="divide-y divide-blue-200 bg-white">
            {[
              ...
              {
                label: "Width",
                values: ["0.85m", "0.85m", "0.85m", "0.85m"],
              },
              {
