    ...
    <div className="w-full">
      ...
      <div className="bg-[#F1F5F9] max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-24 py-10 rounded-xl shadow-sm">
        ...
        <p className="text-gray-700 text-sm leading-relaxed">
          ...
          accessible and user friendly when working with tools. Stairways and
          landing platforms add to the all-round safety. Our professionals
          adhere to industry standards and ensure to opt for machinery and
          manual tests before dispatching the scaffolding to the clients. Making
          use of the perfect access equipment can reduce your workload
          significantly and help you complete your task more quickly and safely.
          You can also trust our knowledge to ensure that you get the right
          equipment in accordance with your job requirement.
        </p>
      </div>
